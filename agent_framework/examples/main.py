...
from examples.workflows import get_workflow_creator, list_available_workflows
...
def initialize_rag(config: Dict[str, Any]):
    ...
    try:
        import sys
        sys.path.append('C:/Users/user/Projects/aisap/rag_pipeline/test_engines/level2/rag/')
